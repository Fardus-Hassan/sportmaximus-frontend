    ...
    <Container className="py-10 sm:py-16 mt-16">
      <div className="">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-2 text-sm sm:text-base text-text-primary/60 text-center">
            Please read these terms carefully before using Beautiworx.
          </p>

          <div className="mt-8 space-y-6 text-sm sm:text-base text-text-primary/70 leading-relaxed">
            <p>
