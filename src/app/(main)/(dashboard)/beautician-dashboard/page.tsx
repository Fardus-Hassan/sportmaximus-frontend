...
export default function BeauticianDashboard() {
  ...
  return (
    <RoleGuard allowedRoles={["beautician"]} fallbackUrl="/">
        ...
        <PageLayout
          ...
          leftColumn={
            <UserInfoSideBar
              role="beautician"
              profile={{
                name: user?.firstName + " " + user?.lastName || "Beautician",
                ...
                avatar: user?.avatar || "https://images.pexels.com/photos/3997391/pexels-photo-3997391.jpeg?auto=compress&cs=tinysrgb&w=400",
